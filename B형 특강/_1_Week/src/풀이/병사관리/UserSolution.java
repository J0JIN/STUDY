...
public class UserSolution {
    ...
    public Node[] node = new Node[200_055];
    public int cnt = 0;
    public int[] version = new int[100_055];  // version[i] := ID 가 i 인 사람의 최신 버전
    public int[] num = new int[100_055];      // num[i] := ID 가 i 인 사람의 team 번호
